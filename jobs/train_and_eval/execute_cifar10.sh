for seed in 2018 2019 2020; do
    ...
    for gamma in 0.2 0.5 1.0 2.0 5.0 10.0 20.0; do
        for steps in 2 3 5; do
            # DRL
             python3 -u train_ss_mn.py --config=configs/cifar10ss_drl.yml \
            ...
            # SSDRL with max_classes=1`
             python3 -u train_ss_mn.py --config=configs/cifar10ss_ssdrl_fast.yml \
    ...
    for eps in 0.5 1.0 2.0 5.0 10.0 20.0 50.0; do
        # VAT
         python3 -u train_ss_mn.py --config=configs/cifar10ss_vat.yml \
